...
class FilterCatalogEntry(Boost.Python.instance):
    ...
    def ClearProp(self, key: typing.Any) -> None:
        """
            C++ signature :
                void ClearProp(RDKit::FilterCatalogEntry {lvalue},std::__1::basic_string_view<char, std::__1::char_traits<char>>)
        """
    ...
    def GetProp(self, key: typing.Any) -> str:
        """
            C++ signature :
                std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> GetProp(RDKit::FilterCatalogEntry {lvalue},std::__1::basic_string_view<char, std::__1::char_traits<char>>)
        """
    ...
    def SetProp(self, key: typing.Any, val: str) -> None:
        """
            C++ signature :
                void SetProp(RDKit::FilterCatalogEntry {lvalue},std::__1::basic_string_view<char, std::__1::char_traits<char>>,std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>)
        """
    @typing.overload
    def __init__(self) -> None:
        """
